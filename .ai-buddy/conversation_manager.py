...
class ConversationManager:
    ...
    def __init__(self, session_id: str, sessions_dir: str):
        ...
        self.conversation_file = os.path.join(sessions_dir, f"conversation_{session_id}.json")
    ...
    def get_recent_context(self, num_exchanges: int = 3) -> str:
        ...
        for i, exchange in enumerate(recent, 1):
            ...
            context_parts.append(f"A: {exchange['response'][:500]}...")  # Truncate long responses
